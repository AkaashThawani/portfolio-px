// Redesigned Footer for minimal, elegant portfolio
  ...
  return (
    <footer className="footer">
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 px-4">
        {/* <div className="font-bold text-lg hero-title">Akaash Thawani</div> */}
        ...
        <div className="text-gray-400 text-sm mt-4 md:mt-0">&copy; {currentYear} Akaash Thawani. All rights reserved.</div>
      </div>
    </footer>
  )
}
